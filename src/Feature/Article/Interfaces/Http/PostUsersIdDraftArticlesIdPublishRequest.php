...
readonly class PostUsersIdDraftArticlesIdPublishRequest
{
    ...
    public static function new(string|int $user_id, string|int $article_id, string $title, string $body, array $thumbnail_file, array $image_files, string $tags_row): PostUsersIdDraftArticlesIdPublishRequest|InvalidArgumentException|InvalidArticleParameterException|InvalidUploadImageException
    {
