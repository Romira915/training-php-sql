...
class PostUsersIdArticlesIdDeleteRequest
{
    public int $user_id;
    ...
    public static function new(int|string $user_id, int|string $article_id): PostUsersIdArticlesIdDeleteRequest|InvalidArgumentException
    {
