...
use PDO;
use Romira\Zenita\Feature\Auth\Domain\Entities\User;
...
class UserRepository
{
    ...
    public static function findById(PDO $pdo, int $id): ?User
    {
        $statement = $pdo->prepare('
            SELECT
                u.id,
    ...
    public static function findByDisplayName(PDO $pdo, string $display_name): ?User
    {
        $statement = $pdo->prepare('
            SELECT
                u.id,
